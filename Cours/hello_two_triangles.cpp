...
*/
    unsigned int VBO, VAO;//, EBO; //on cree l'ebo, tampon pour les indices a utiliser
  ...
  //  glGenBuffers(1, &EBO);
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW); //changer par indices pour utiliser ebo
