...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Orange et Jaune", NULL, NULL);
    if (window == NULL)
    {
    ...
    //glDeleteShader(vertexShader); on reutilise le meme pour l'autre triangle
    ...
    glDeleteShader(vertexShader); //maintenant on peut le supprimer
   ...
   float vertices_2[] = {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // dessine le triangle orange
        glUseProgram(shaderProgramOrange); //on utilise le shader orange
        ...
        // dessine le triangle yellow
        glUseProgram(shaderProgramYellow); //on utilise le shader orange
        glBindVertexArray(VAO_2);
